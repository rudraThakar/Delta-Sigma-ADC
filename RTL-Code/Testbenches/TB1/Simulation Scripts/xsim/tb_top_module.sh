...
#
# Script generated by Vivado on Sun Dec 07 04:52:57 +0530 2025
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_top_module.sh
...
#
# Usage        : tb_top_module.sh
#                tb_top_module.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_top_module.sh [-rerun]
#                tb_top_module.sh [-reset_run]
#                tb_top_module.sh [-clean]
#                tb_top_module.sh [-reset_log]
#                tb_top_module.sh [-help]
#
...
# script info
echo -e "tb_top_module.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_top_module.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_top_module xil_defaultlib.tb_top_module xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_top_module -key {Behavioral:sim_1:Functional:tb_top_module} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_top_module.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_top_module.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_top_module.sh [-help]\n\
Usage: tb_top_module.sh [-step]\n\
Usage: tb_top_module.sh [-lib_map_path]\n\
Usage: tb_top_module.sh [-rerun]\n\
Usage: tb_top_module.sh [-reset_run]\n\
Usage: tb_top_module.sh [-clean]\n\
Usage: tb_top_module.sh [-reset_log]\n\
Usage: tb_top_module.sh [-keep_index]\n\
Usage: tb_top_module.sh [-noclean_files]\n\n\
